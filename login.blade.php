...
<body class="hold-transition login-page">
    ...
    <script>
        ...
        $(function() {
            ...
            const $submitButton = $form.find(".submit_button");
            ...
            function handleBranchSelection(response) {
                ...
                const $branchSelect = $(".branch_id").empty();
                $branchSelect.append(new Option('Select Company Name', ''));
                
                response.data.forEach(function(branch) {
                    $branchSelect.append(new Option(branch.Name, branch.Sys_ID));
                });
                
                // Store user data in form
                Object.keys(response).forEach(function(key) {
                    if (key !== 'data' && key !== 'status_code') {
